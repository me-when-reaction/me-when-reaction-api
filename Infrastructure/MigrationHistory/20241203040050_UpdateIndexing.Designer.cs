...
namespace MeWhenAPI.Infrastructure.MigrationHistory
{
    ...
    [Migration("20241203040050_UpdateIndexing")]
    partial class UpdateIndexing
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MeWhenAPI.Domain.Model.ImageModel", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("MeWhenAPI.Domain.Model.ImageTagModel", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("MeWhenAPI.Domain.Model.TagModel", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    NpgsqlIndexBuilderExtensions.IncludeProperties(b.HasIndex("Name"), new[] { "ID", "AgeRating", "Alias" });

                    b.ToTable("tr_tag", (string)null);
                });

            modelBuilder.Entity("MeWhenAPI.Domain.Model.UserModel", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("MeWhenAPI.Domain.Model.ImageTagModel", b =>
                {
                    b.HasOne("MeWhenAPI.Domain.Model.ImageModel", "Image")
                        .WithMany("Tags")
                        .HasForeignKey("ImageID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MeWhenAPI.Domain.Model.TagModel", "Tag")
                        .WithMany("TagsUsed")
                        .HasForeignKey("TagID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
